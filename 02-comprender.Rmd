...
Como verán, esta función resulta útil para ver valores agregados de toda la base, sin embargo, si agrupamos los datos previo a calular los resumenes, los resultados comienzan a ser más específicos. Para esto vamos a utilizar `summarise()` junto a `group_by()`. Veamos un ejemplo:
...
Con la agrupación y el resumen podemos ver que la superficie cubierta promedio de las propiedades en alquiler er 72,93m2 y la de las propiedades en venta es 97,28m2.
...
Como verán, en ambos casos llegamos al mismo resultado, pero sin dudas, la segunda opción es la más óptima.
